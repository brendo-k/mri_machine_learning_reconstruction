...
class NormUnet(nn.Module):
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        # get shapes for unet and normalize [b cmplx, h, w]
...
class SensitivityModel(nn.Module):
    ...
    def get_pad_and_num_low_freqs(
        ...
        if num_low_frequencies is None or num_low_frequencies == 0:
            ...
            print('low_freq', num_low_frequencies_tensor)
        else:
...
class VarNet(nn.Module):
    ...
    def forward(
        ...
        print('STARTING')
        ## MY CODE ##
        masked_kspace = torch.view_as_real(masked_kspace).squeeze(1)
        mask = masked_kspace != 0 
        print(masked_kspace.mean())
        ## END ##
        ...
        return torch.view_as_complex(kspace_pred).unsqueeze(1)
