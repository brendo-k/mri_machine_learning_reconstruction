...
class normalize(object):
    ...
    def __call__(self, sample):
        ...
        doub_under, under, sampled, omega_mask, lambda_mask = sample
        ...
        return (doub_under/undersample_max, under/undersample_max, sampled/undersample_max, omega_mask, lambda_mask)
